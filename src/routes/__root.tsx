...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Fishermen Movement — Cyber Safety Awareness Campaign" },
      { property: "og:description", content: "Protecting young minds in the digital age across Nigeria." },
